var Character = Class.extend({
    ...
    motion: function () {
        ...
        this.direction.multiplyScalar(0.9);
        // If we're not static
        if (Math.abs(this.direction.x) > 0 || Math.abs(this.direction.z) > 0) {
    ...
    collision: function () {
        ...
        for (i = 0; i < this.rays.length; i += 1) {
            ...
            if (collisions.length > 0 && collisions[0].distance <= distance) {
                ...
                if ((i === 0 || i === 1 || i === 7) && this.direction.z > 0) {
                    this.direction.setZ(0);
                } else if ((i === 3 || i === 4 || i === 5) && this.direction.z < 0) {
                    this.direction.setZ(0);
                }

                if ((i === 1 || i === 2 || i === 3) && this.direction.x > 0) {
                    this.direction.setX(0);
                } else if ((i === 5 || i === 6 || i === 7) && this.direction.x < 0) {
                    this.direction.setX(0);
                }
            }
        }
